...
class Player():
    ...
    def __init__(self,_name:str,_lv:int=0,_hp:float=0,_hpMax:float=0,_mana:int=0,_manaMax:int=0,_atk:int=0,_def:int=0,_matk:int=0,_mdef:int=0,
    _money:int=0,_exp:int=0,_nextExp:int=0):
        self.Name = _name
        self.Lv = _lv
        self.Hp = _hp
        self.Atk = _atk
